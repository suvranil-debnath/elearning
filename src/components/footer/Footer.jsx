  ...
  return (
    <>
        <div className="container-fluid">
          <div className="row">
            {/* Left Column */}
            <div className="col-lg-4 col-md-6 col-sm-12 faq-left">
            ...
            {/* middle Column */}
            <div className="col-lg-4 col-md-6 col-sm-12 faq-right">
              <ol className="faq-list">
                <li>
                  <h2>Do I Need To Quit My Job?</h2>
                </li>
                <li>
                  <h2>Do I Need To Quit My Job?</h2>
                </li>
            ...
            {/* Right Column */}
            <div className="col-lg-4 col-md-6 col-sm-12 paragraph">
              <ol className="faq-list">
                <br />
                <p>
                  Here is some text that explains why you might consider
                  quitting your job...
                </p>
                <br />
                <p>
